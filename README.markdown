...
This is a fork of github.com/andre/geokit-rails.git.
The only thing that changed is that the distance column is not rendered in the results. This solves the problem that :select option in a named scope is overwritten by the GeoKit plugin.
